...
package com.example.demo.googleapis;
...
public class OAuth2Sample {
   ...
   */
  private static final String APPLICATION_NAME = "OAuth2Test";
  ...
  private static Credential authorize() throws Exception {
    ...
    // authorize
    return new AuthorizationCodeInstalledApp(flow, new LocalServerReceiver.Builder().setPort(12345).setCallbackPath("/hello").build()).authorize("user");
  }

  public static Credential login() throws Exception {
      // authorization
  ...
  public static String userInfo() throws IOException {
    ...
    com.google.api.services.oauth2.model.Userinfo a = userinfo.get().execute();
